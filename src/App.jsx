...
import { getAllProgress, getAllFlashcards } from './lib/db.js'
import { getDueCards } from './lib/srs.js'
import { hasApiKey, saveSettings } from './lib/storage.js'
...
export default function App() {
  ...
  // Re-read progress, due count, and key status. Children call this after they
  // change data so the UI (badges, due counts) stays in sync.
  const refresh = useCallback(async () => {
    const [prog, cards] = await Promise.all([getAllProgress(), getAllFlashcards()])
    setProgress(prog)
